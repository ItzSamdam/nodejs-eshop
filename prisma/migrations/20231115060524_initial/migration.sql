...
CREATE TABLE `Order` (
    ...
    `deliveryType` ENUM('NONE', 'HOME_DELIVERY', 'PICKUP') NOT NULL DEFAULT 'NONE',
    `deliveryStatus` ENUM('NONE', 'PENDING', 'EN_ROUTE', 'DELIVERED', 'CANCELLED') NOT NULL DEFAULT 'NONE',
    `price` DOUBLE NOT NULL,
    `discount` DOUBLE NOT NULL,
...
CREATE TABLE `Payment` (
    `id` VARCHAR(191) NOT NULL,
    `type` ENUM('DEBIT_CARD', 'CASH_ON_DELIVERY') NOT NULL,
